...
$\overline{\psi_R} \psi_L$ carries exactly Higgs-typed electroweak quantum numbers (the doublet $H$ or
its conjugate $\widetilde{H}$) in every
...
physical role: fermionic chiral bilinears carry exactly Higgs-typed quantum numbers (the doublet $H$ or
its conjugate $\widetilde{H}$) in every audited Yukawa sector, while neither the physical rotation of
the wave, the gauge group, nor this representation typing determines whether, which, or at what scale
such a bilinear condenses.
